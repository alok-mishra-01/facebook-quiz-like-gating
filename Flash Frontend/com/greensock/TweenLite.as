 ...
 */	 
	public class TweenLite extends TweenCore {
		...
		public static function initClass():void {
			...
			TweenPlugin.activate([Physics2DPlugin,TransformAroundCenterPlugin,MotionBlurPlugin]);//allows you to apply basic physics in 2D space, like velocity, angle, gravity, friction, acceleration, and accelerationAngle. **Club GreenSock membership benefit**
