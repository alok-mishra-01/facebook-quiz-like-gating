	...
	public class DisplayObjectLoader extends LoaderItem {
		...
		protected function _refreshLoader(unloadContent:Boolean=true):void {
			if (_loader != null) {
				...
				_loader.contentLoaderInfo.removeEventListener("httptatus", _httptatusHandler);
			...
			_loader.contentLoaderInfo.addEventListener("httptatus", _httptatusHandler, false, 0, true);
