...
package com.greensock.loading {
	...
	/** Dispatched when the loader's <code>httptatus</code> value changes. **/
	[Event(name="httptatus", 		type="com.greensock.events.LoaderEvent")]
 ...
 * 		<li><strong> onhttptatus : Function</strong> - A handler function for <code>LoaderEvent.HTTP_STATUS</code> events. Make sure your onhttptatus function accepts a single parameter of type <code>LoaderEvent</code> (<code>com.greensock.events.LoaderEvent</code>). You can determine the httptatus code using the LoaderEvent's <code>target.httptatus</code> (LoaderItems keep track of their <code>httptatus</code> when possible, although certain environments prevent Flash from getting httptatus information).</li>
 * </ul><br />
 * 
 ...
 */	
	public class DataLoader extends LoaderItem {
		...
		public function DataLoader(urlOrRequest:*, vars:Object=null) {
			...
			_loader.addEventListener("httptatus", _httptatusHandler, false, 0, true);
		}
