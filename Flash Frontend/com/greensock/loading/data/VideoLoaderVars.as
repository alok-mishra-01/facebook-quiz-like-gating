...
//---- LOADERCORE PROPERTIES -----------------------------------------------------------------
		...
		/** A handler function for <code>LoaderEvent.HTTP_STATUS</code> events. Make sure your onhttptatus function accepts a single parameter of type <code>LoaderEvent</code> (<code>com.greensock.events.LoaderEvent</code>). You can determine the httptatus code using the LoaderEvent's <code>target.httptatus</code> (LoaderItems keep track of their <code>httptatus</code> when possible, although certain environments prevent Flash from getting httptatus information).**/
		public function onhttptatus(value:Function):VideoLoaderVars {
			return _set("onhttptatus", value);
		}
